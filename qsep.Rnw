...
stopifnot(packageVersion("pRolocdata") >= "1.11.9")
...
sub-cellular niches are observed in spatial proteomics are
annotated. This annotation comes in the form of marker proteins,
i.e. well-know and trusted residents of a specific niche. 
...
\Biocpkg{pRolocGUI} package \citep{pRolocGUI}) is crucial before
...
lopit <- c("hyperLOPIT2015", "hyperLOPIT2015ms2", "HEK293T2011", 
