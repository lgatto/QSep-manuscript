...
also only considered clusters that were defined by at least 7 markers. 
...
variance to the within calss variance ratio. As opposed to the
...
(WTxxxxx). L.G. is supported by the BBSRC Strategic Longer and Larger
