...
localisation of thousands of proteins. Most
...
## NOTES: beltran2016HCMV24 and beltran2016MOCK96 chosen as best mean/median
## QSep values for each condition. If only best, use beltran2016MOCK96.
.experiments <- c("E14TG2aS1", "HEK293T2011", "andreyev2010rest", "dunkley2006",
                  ...
                  "beltran2016HCMV24", "beltran2016MOCK96", "hirst2018", "itzhak2017",
                  "hyperLOPITU2OS2017b")
...
.pos[pdataitems == "tan2009r1"] <- 4
.pos[pdataitems == "trotter2010"] <- 2
.pos[pdataitems == "hall2009"] <- 1
.pos[pdataitems == "dunkley2006"] <- 1
.pos[pdataitems == "beltran2016HCMV24"] <- 2
.pos[pdataitems == "beltran2016MOCK96"] <- 2
.pos[pdataitems == "E14TG2aS1"] <- 4
.pos[pdataitems == "HEK293T2011"] <- 1
.pos[grep("hyperLOPIT", pdataitems)] <- 1
.pos[pdataitems == "hyperLOPIT2015ms2"] <- 2
.pos[pdataitems == "hyperLOPIT2015"] <- 2
.pos[pdataitems == "hyperLOPITU2OS2017b"] <- 1
plot(mds ~ pdtab$year,
     xlim = c(2005, 2018.5),
