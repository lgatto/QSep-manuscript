...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in levelplot(t(qsep(object, norm = norm)), col.regions = pal(n), : could not find function "{}levelplot"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in levelplot(t(qsep(object, norm = norm)), col.regions = pal(n), : could not find function "{}levelplot"{}}}\end{kframe}
\end{knitrout}
...
\begin{itemize}\raggedright
  \item R version 3.5.1 Patched (2018-10-10 r75432), \verb|x86_64-pc-linux-gnu|
  ...
  \item Other packages: annotate~1.59.1, AnnotationDbi~1.43.1,
    Biobase~2.41.2, BiocGenerics~0.27.1, BiocParallel~1.15.15,
    cluster~2.0.7-1, ggplot2~3.0.0, ggrepel~0.8.0, hexbin~1.27.2,
    IRanges~2.15.18, MLInterfaces~1.61.1, MSnbase~2.7.8,
    mzR~2.15.5, pRoloc~1.21.8, pRolocdata~1.19.5,
    ProtGenerics~1.13.0, Rcpp~0.12.19, S4Vectors~0.19.22,
    XML~3.98-1.16, xtable~1.8-3
  \item Loaded via a namespace (and not attached): abind~1.4-5,
    affy~1.59.1, affyio~1.51.0, assertthat~0.2.0, backports~1.1.2,
    base64enc~0.1-3, bindr~0.1.1, bindrcpp~0.2.2,
    BiocManager~1.30.3, biomaRt~2.37.8, bit~1.1-14, bit64~0.9-7,
    ...
    data.table~1.11.8, DBI~1.0.0, ddalpha~1.3.4, dendextend~1.8.0,
    DEoptimR~1.0-8, digest~0.6.18, dimRed~0.1.0, diptest~0.75-7,
    doParallel~1.0.14, dplyr~0.7.6, DRR~0.0.3, e1071~1.7-0,
    evaluate~0.12, flexmix~2.3-14, FNN~1.1.2.1, foreach~1.4.4,
    fpc~2.1-11.1, gbm~2.1.4, gdata~2.18.0, genefilter~1.63.2,
    ...
    impute~1.55.0, ipred~0.9-7, iterators~1.0.10, kernlab~0.9-27,
    knitr~1.20, labeling~0.3, LaplacesDemon~16.1.1, later~0.7.5,
    lattice~0.20-35, lava~1.6.3, lazyeval~0.2.1, limma~3.37.9,
    lpSolve~5.6.13, lubridate~1.7.4, magic~1.5-9, magrittr~1.5,
    MALDIquant~1.18, MASS~7.3-50, Matrix~1.2-14, mclust~5.4.1,
    memoise~1.1.0, mime~0.6, mixtools~1.1.0, mlbench~2.1-1,
    ModelMetrics~1.2.0, modeltools~0.2-22, munsell~0.5.0,
    mvtnorm~1.0-8, mzID~1.19.0, ncdf4~1.16, nlme~3.1-137,
    nnet~7.3-12, pcaMethods~1.73.1, pillar~1.3.0, pkgconfig~2.0.2,
    pls~2.7-0, plyr~1.8.4, prabclus~2.2-6, preprocessCore~1.43.0,
    ...
    rlang~0.2.2, robustbase~0.93-3, rpart~4.1-13, RSQLite~2.1.1,
    sampling~2.8, scales~1.0.0, segmented~0.5-3.0, sfsmisc~1.1-2,
    shiny~1.1.0, splines~3.5.1, stringi~1.2.4, stringr~1.3.1,
    survival~2.42-6, threejs~0.3.1, tibble~1.4.2, tidyr~0.8.1,
    tidyselect~0.2.5, timeDate~3043.102, tools~3.5.1,
    trimcluster~0.1-2.1, viridis~0.5.1, viridisLite~0.3.0,
    vsn~3.49.1, whisker~0.3-2, withr~2.1.2, zlibbioc~1.27.0
\end{itemize}
