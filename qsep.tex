...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=1\linewidth]{figure/restime-1} 
...
due to the limited number of datasets (29 dataset,
out of 18 individual publications), as well as confounding
...
\begin{itemize}\raggedright
  ...
  \item Other packages: annotate~1.60.0, AnnotationDbi~1.44.0,
    ...
    MSnbase~2.8.0, mzR~2.16.0, pRoloc~1.23.1, pRolocdata~1.20.0,
    ProtGenerics~1.14.0, Rcpp~0.12.19, S4Vectors~0.20.0,
