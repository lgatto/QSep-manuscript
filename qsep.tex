...
\begin{itemize}\raggedright
  ...
  \item Other packages: annotate~1.59.1, AnnotationDbi~1.43.1,
    ...
    IRanges~2.15.18, lattice~0.20-35, MLInterfaces~1.61.1,
    MSnbase~2.7.8, mzR~2.15.5, pRoloc~1.21.8, pRolocdata~1.19.5,
  ...
  \item Loaded via a namespace (and not attached): abind~1.4-5,
    ...
    lava~1.6.3, lazyeval~0.2.1, limma~3.37.9, lpSolve~5.6.13,
    lubridate~1.7.4, magic~1.5-9, magrittr~1.5, MALDIquant~1.18,
    MASS~7.3-50, Matrix~1.2-14, mclust~5.4.1, memoise~1.1.0,
    mime~0.6, mixtools~1.1.0, mlbench~2.1-1, ModelMetrics~1.2.0,
    modeltools~0.2-22, munsell~0.5.0, mvtnorm~1.0-8, mzID~1.19.0,
    ncdf4~1.16, nlme~3.1-137, nnet~7.3-12, pcaMethods~1.73.1,
    pillar~1.3.0, pkgconfig~2.0.2, pls~2.7-0, plyr~1.8.4,
    prabclus~2.2-6, preprocessCore~1.43.0, prettyunits~1.0.2,
    ...
    rda~1.0.2-2.1, recipes~0.1.3, reshape2~1.4.3, rlang~0.2.2,
    robustbase~0.93-3, rpart~4.1-13, RSQLite~2.1.1, sampling~2.8,
    scales~1.0.0, segmented~0.5-3.0, sfsmisc~1.1-2, shiny~1.1.0,
    splines~3.5.1, stringi~1.2.4, stringr~1.3.1, survival~2.42-6,
    threejs~0.3.1, tibble~1.4.2, tidyr~0.8.1, tidyselect~0.2.5,
    timeDate~3043.102, tools~3.5.1, trimcluster~0.1-2.1,
    viridis~0.5.1, viridisLite~0.3.0, vsn~3.49.1, whisker~0.3-2,
    withr~2.1.2, zlibbioc~1.27.0
\end{itemize}
